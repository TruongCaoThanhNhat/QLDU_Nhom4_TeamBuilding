...
<div class="container pt-2 w-100">
  ...
  <div class="d-flex justify-content-between w-100" style="height: 650px;">
    ...
    <div class="bg-concept col-8 "
         style="border-radius: 20px; padding: 0 44px; font-family: 'Jost*', sans-serif;">
      ...
      <div class="d-flex flex-column pt-2" style="display: none !important;">
        ...
        <div class="bg-white mt-3 d-flex justify-content-center"
             style="border-radius: 20px;font-size: 25px; padding: 12px 16px;">
          Đáp án đúng: Lịch sử <br>
          Vì lịch sử bao gồm toàn bộ quá trình phát triển của nhân loại từ thời tiền sử đến hiện đại.
        </div>
        <div class="d-flex justify-content-between align-items-center">
          <img style="height: 80px;" class="mt-2" src="/assets/img/waiting-screen/congratulate.png"
               alt="">
          <button
      ...
      <div class="d-flex flex-column pt-2" style="display: none !important;">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <img style="height: 80px;" class="mt-2" src="/assets/img/waiting-screen/out-of-time.png" alt="">
          <button
                  style="background-color: #F5F061; padding: 8px 16px; border-radius: 10px; font-size: 25px; height: fit-content; border: none;">Tiếp
            tục</button>
        </div>
